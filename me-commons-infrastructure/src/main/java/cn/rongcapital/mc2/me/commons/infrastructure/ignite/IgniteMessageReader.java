...
import cn.rongcapital.mc2.me.commons.api.ApiMessage;
import cn.rongcapital.mc2.me.commons.api.ApiResult;
import cn.rongcapital.mc2.me.commons.util.GsonUtils;

public class IgniteMessageReader implements InitializingBean {
	...
	public ApiResult<?> read(String className, String methodName, String messageCode) {
